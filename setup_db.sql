...
INSERT INTO `languages` VALUES (1,'C++','cpp',1,'ace/mode/c_cpp','[\"{2}\",\"{3}\",\"{4}\"]','[\"{4}\"]','source.cpp'),
(2,'C++11','cpp11',1,'ace/mode/c_cpp','[\"{2}\",\"{3}\",\"{4}\"]','[\"{4}\"]','source.cpp')
(3,'C++14','cpp14',1,'ace/mode/c_cpp','[\"{2}\",\"{3}\",\"{4}\"]','[\"{4}\"]','source.cpp')
(4,'C99','c99',1,'ace/mode/c_cpp','[\"{2}\",\"{3}\",\"{4}\"]','[\"{4}\"]','source.c');

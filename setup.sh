...
sudo apt install -y --no-install-recommends git vim nodejs nodejs-legacy npm apt-transport-https ca-certificates curl software-properties-common mysql-server
